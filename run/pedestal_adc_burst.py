...
def main(LRS=_default_LRS, \
         ...
         i_rx=_default_i_rx, \
         adc_burst_length=_default_adc_burst_length, \
         **kwargs):
    ...
    for g_c in iog_ioc.keys():
        ok, diff=asic_base.enable_pedestal_adc_burst_config_by_io_channel(c, io, \
                                                                iog_ioc[g_c],\
                                                    vref_dac, vcm_dac, \
...
if __name__=='__main__':
    ...
    parser.add_argument('--adc_burst_length', \
                        default=_default_adc_burst_length, \
                        type=int, \
                        help='''Number of ADC conversions before reset''')
